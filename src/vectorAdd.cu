...
#define N (1 << 24)   // 16 millones de elementos

/* ── Kernel CUDA: cada thread suma un par de elementos ── */
...
int main() {
    ...
    /* Crear eventos para medir tiempo en GPU */
    ...
    /* Medir solo el kernel (sin memcpy) */
